      ...
      <main className="min-h-screen bg-[#003d35] px-6 py-16 text-white">
        ...
        <div className="mx-auto max-w-md">
          ...
          <section className="mt-10 rounded-xl border border-[#1b5b51] bg-[#06483f] p-8">
            ...
            <a
              href="/login/google"
              className="block w-full rounded-md bg-white px-6 py-3 text-center font-bold text-[#003d35]"
            >
            ...
            <a
              href="/report"
              className="mt-4 block w-full rounded-md border border-[#1b5b51] px-6 py-3 text-center font-bold text-white"
            >
              Continue as Guest
            </a>
