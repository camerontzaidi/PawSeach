  ...
  return (
    <main className="min-h-screen bg-[#003d35] px-4 py-10 text-white sm:px-6">
      <div className="mx-auto max-w-4xl animate-pulse">
        ...
        <div className="h-10 w-72 rounded bg-[#1b5b51]" />

        <div className="mt-3 h-5 w-64 rounded bg-[#1b5b51]" />
        ...
        <section className="mt-8 rounded-2xl border border-[#1b5b51] bg-[#06483f] p-6">
          ...
          <div className="mt-6 flex justify-between">
            ...
            <div className="h-9 w-24 rounded-full bg-[#1b5b51]" />
          </div>
          ...
          {/* Circumstances */}
          <div className="mt-6 h-32 rounded-lg bg-[#1b5b51]" />
