  ...
  return (
    <header className="border-b border-[#1b5b51] bg-[#003d35]">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 text-white">
        <Link href="/" className="text-2xl font-bold tracking-tight">🐾 PawSearch</Link>

        <div className="hidden items-center gap-6 md:flex">
          <Link href="/" className="font-semibold transition hover:text-[#fbb12c]">Home</Link>
          <Link href="/dogs" className="font-semibold transition hover:text-[#fbb12c]">Missing Pets</Link>
          <Link href="/sightings" className="font-semibold transition hover:text-[#fbb12c]">Found Animals</Link>
          <Link href="/how-it-works" className="font-semibold transition hover:text-[#fbb12c]">How It Works</Link>
        </div>
              ...
              {open && (
                <div className="absolute right-0 z-50 mt-3 w-56 rounded-xl border border-[#1b5b51] bg-[#06483f] p-3 shadow-lg">
                  <div className="border-b border-[#1b5b51] pb-3">
                    ...
                    <p className="truncate text-sm text-[#b7d5ce]">{user.email}</p>
                  </div>
