...
return ( <header className="border-b border-[#1b5b51] bg-[#003d35]"> <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 text-white">
{/* Logo */} <Link
       href="/"
          ...
          {open && (
            <div className="absolute right-0 z-50 mt-3 w-56 rounded-xl border border-[#1b5b51] bg-[#06483f] p-3 shadow-lg">
              ...
              <Link
                ...
                className="mt-3 block w-full rounded-md px-3 py-2 text-left transition hover:bg-[#1b5b51]"
              >
                Profile
              </Link>
